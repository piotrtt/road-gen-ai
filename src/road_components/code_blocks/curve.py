...
def generate_curve(component: Curve) -> str:
    """
    Generates code for a curve.
    """
    curve = """# Initialize variables for both roads of the curve. Specify the length (in this case 100m) and number of lanes in each direction.
